...
<div class="row">
        ...
        <div class="xd_top_box">
         <?php echo $ads_720x90; ?>
           ...
           <br />
           <p><?php echo $lang['ATOZ328']; ?></p>
           <form method="POST" action="<?php echo $toolOutputURL;?>" onsubmit="return fixKey();"> 
           <input type="text" name="key" id="key" placeholder="<?php echo $lang['ATOZ328']; ?>" class="form-control" />
           <br />
           ...
           ?>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th style="width: 6%;">#</th>
                    <th style="text-align: center;"><?php echo $lang['ATOZ329']; ?></th>
                </tr>
