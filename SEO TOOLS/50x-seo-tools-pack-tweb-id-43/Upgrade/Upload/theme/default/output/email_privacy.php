...
<div class="row">
        ...
        <div class="xd_top_box">
         <?php echo $ads_720x90; ?>
           ...
           ?>
           <br />
           <p><?php echo $lang['ATOZ98']; ?>: <strong><?php echo $my_url; ?></strong> </p>
           <?php if(isset($noEmail)){ ?>
           <p><?php echo $lang['ATOZ69']; ?>: <strong style="color:green;"><?php echo $noEmail; ?></strong> </p>
           <br />
           <div class="text-center"> 
           <img  src="<?php echo $theme_path; ?>img/okay.png" alt="success" title="Success" />
           </div>
           <?php } else { ?>
           <p><?php echo $lang['ATOZ69']; ?>: <strong style="color:red;"><?php echo $lang['ATOZ191']; ?></strong> </p>
           <br />
             <table class="table table-bordered">
                    <thead>
                          <tr>
                            <th>#</th>
                            <th><?php echo $lang['ATOZ192']; ?></th>
                        </tr>
                    </thead>
                        <tbody>
