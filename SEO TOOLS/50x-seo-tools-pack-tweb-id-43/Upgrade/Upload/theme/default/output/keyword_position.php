...
var msgKey = "<?php makeJavascriptStr($lang['ATOZ170'],true); ?>";
var msgTab1 = "<?php makeJavascriptStr($lang['ATOZ171'],true); ?>";
var msgTab2 = "Google";
var msgTab3 = "Yahoo";
</script>
	...
	<div class="row">
            ...
            <div class="xd_top_box">
             <?php echo $ads_720x90; ?>
               ...
               <div class="col-md-4">
              	<p>&nbsp; <br/><br/><br/><?php echo $lang['ATOZ173']; ?>.<br/><br/>
                <?php echo $lang['ATOZ174']; ?>:<br/>
                keyword1<br/>
                keyword2<br/>
                keyword3 <br/></p>
               </div>
               ...
               <a class="btn btn-info" style="cursor:pointer;" id="checkButton"><?php echo $lang['ATOZ166']; ?></a>
               </div>     
               </div>           
               <?php 
               } 
