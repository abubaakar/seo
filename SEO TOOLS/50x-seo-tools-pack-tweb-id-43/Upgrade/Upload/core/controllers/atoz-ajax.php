  ...
  //Blog Ping
    ...
    if(isset($_POST['keyword'])) {  
     ...
     if($searchKeyword == "" || $searchKeyword == null){
        echo $lang['ATOZ168'].'::|::'.$lang['ATOZ168'];
        die();
     }
     ...
     $resultData = ($googleRes[1] == "" ? $lang['ATOZ167']." $keyPos" : ordinal($googleRes[1])." ".$lang['ATOZ169']). "::|::". ($yahooRes[1] == "" ? $lang['ATOZ167']." $keyPos" : ordinal($yahooRes[1])." ".$lang['ATOZ169']);
     echo $resultData;
     die();
    }else{
        echo $lang['ATOZ4'].'::|::'.$lang['ATOZ4'];
        die();
    }
    }
...
if(isset($_POST['getMobileFriendly'])){
    ...
    if(!isset($error)){
    if($isMobileFriendly){
        $isMobileFriendlyMsg = $lang['ATOZAD82'];
        $isMobileFriendlyColor = "2cc36b";
    }
    else{
        $isMobileFriendlyMsg = $lang['ATOZAD83'];
    ...
    echo '              <div class="mobileRes">
                        <br />         
                         <table class="table table-bordered">
                            <tbody>
                            <tr>
                                <td><strong>'.$lang['ATOZ24'].'</strong></td>
                                <td>'.$myHost.'</td>
                            </tr>
                            <tr>
                                <td><strong>'.$lang['ATOZ69'].'</strong></td>
                                <td style="color: #'.$isMobileFriendlyColor.'; font-size: 18px;">'.$isMobileFriendlyMsg.'</td>
                            </tr>
                            <tr>
                                <td><strong>'.$lang['ATOZAD84'].'</strong></td>
                                <td>      
                            ...
                            <tr>
                                <td><strong>'.$lang['ATOZAD85'].'</strong></td>
    ...
    die();
        ...
        <strong>Alert!</strong> '.$lang['ATOZ97'].'
        </div>
        </div>';
        die();
    }
