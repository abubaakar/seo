           ...
           ?>
                    ...
                    <table class="table table-bordered">
                            <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 200px;"><?php echo $lang['ATOZ107']; ?>: </td>
                                        <td><strong><?php echo $getHostIP; ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 200px;"><?php echo $lang['ATOZ207']; ?>: </td>
                                        <?php 
                                        if ($overAll == 1)
                                        echo '<td style="color:#c0392b; font-weight:bold;">'.$lang['ATOZ205'].'</td>';
                                        else
                                        echo '<td style="color:#27ae60; font-weight:bold;">'.$lang['ATOZ206'].'</td>';
                                        ?>
                                    </tr>
                                </tbody>
                    </table>
                         ...
                         <table class="table table-hover table-bordered table-striped">
                            <thead>
                                <th>#</th>
                                <th><?php echo $lang['ATOZ208']; ?></th>
                                <th><?php echo $lang['ATOZ69']; ?></th>
                            </thead>
                                    <tbody>
