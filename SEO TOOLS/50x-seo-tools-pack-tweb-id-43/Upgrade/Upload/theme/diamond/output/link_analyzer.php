...
<div class="row">
        ...
        <thead>
                <tr>
                <td><?php echo $lang['ATOZ46']; ?></td>
                <td><?php echo $lang['ATOZ47']; ?></td>
                </tr>
             </thead>
                <tbody>
                <tr>
                    <td><strong><?php echo $lang['ATOZ48']; ?></strong></td>
                     <td><span class="badge bg-blue"><?php   echo $total_links; ?></span></td>

                </tr>
                <tr>
                    <td><strong><?php echo $lang['ATOZ49']; ?></strong></td>
                    <td><span class="badge bg-green"><?php   echo $internal_links_count; ?></span></td>

                </tr>
                <tr>
                   <td><strong><?php echo $lang['ATOZ50']; ?></strong></td>
                    <td><span class="badge bg-purple"><?php   echo $external_links_count; ?></span></td>
                </tr>
                <tr>
                   <td><strong><?php echo $lang['ATOZ51']; ?></strong></td>
    ...
    <br />
    <h3><?php echo $lang['ATOZ49']; ?> <small><?php echo $lang['ATOZ52']; ?></small></h3><br />
          <table class="table table-bordered table-responsive">
            <thead>
                <tr>
                    <td>No.</td>
                    <td><?php echo $lang['ATOZ53']; ?></td>
                    <td><?php echo $lang['ATOZ54']; ?></td>
                </tr>
             </thead>
                <tbody>
                <?php 
                $rawData .= $lang['ATOZ49']."\n"."\n";
                $rawData .= 'No.,'.$lang['ATOZ53'].','.$lang['ATOZ54']."\n";
            ...
            <br />
    <h3><?php echo $lang['ATOZ50']; ?> <small><?php echo $lang['ATOZ55']; ?></small></h3><br />
      <table class="table table-bordered table-responsive">
        <thead>
            <tr>
                <td>No.</td>
