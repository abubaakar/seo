...
<div class="row">
        ...
        <div class="xd_top_box">
         <?php echo $ads_720x90; ?>
           ...
           <input class="btn btn-info" type="submit" value="<?php echo $lang['ATOZ109']; ?>" name="submit"/>
           </div>
           </form>     
         ...
         <br />
            <div class="box box-success">
                            ...
                            <div class="box-body">
                            <strong><?php echo $lang['ATOZ98']; ?>:</strong>  <?php echo $my_url; ?> <br /> <br />
                            <strong><?php echo $lang['ATOZ110']; ?>:</strong> <br />
