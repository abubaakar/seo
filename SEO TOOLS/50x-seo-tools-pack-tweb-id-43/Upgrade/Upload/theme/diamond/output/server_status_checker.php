...
<div class="row">
    ...
    <br />
    <h3><?php echo $lang['ATOZ64']; ?> <small> <?php echo $lang['ATOZ65']; ?></small></h3><br />
          <table class="table table-bordered">
            <thead>
                <tr>
                <td>No.</td>
                    <td><?php echo $lang['ATOZ66']; ?></td>
                    <td><?php echo $lang['ATOZ67']; ?></td>
                    <td><?php echo $lang['ATOZ68']; ?></td>
                    <td><?php echo $lang['ATOZ69']; ?></td>
                </tr>
             </thead>
                <tbody>
        ...
        <br /> &nbsp; <br />
        <a class="btn btn-info" href="<?php echo $toolURL; ?>"><?php echo $lang['ATOZ63']; ?></a>
        <br />
        </div>
