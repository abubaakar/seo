 ...
 */
?>
<script>var msgDomain = "<?php makeJavascriptStr($lang['ATOZ23'],true); ?>";</script>
         ...
         <?php echo $ads_720x90; ?>
           ...
           <p><?php echo $lang['ATOZ23']; ?>
            ...
            <form  onsubmit="doscreen_simulator(); return false">	
                  ...
                  <br />  <br />  <?php echo $lang['ATOZ33']; ?>:
					<div class="radio-box">
                        <div class="form-group">
						<input type="radio" id="160x160"  name="resolution" value="160x160" />
						<label for="160x160">&nbsp;160x160 <?php echo $lang['ATOZ34']; ?></label>
						<div class="clear">&nbsp;</div></div>
						
						<input type="radio" id="320x320"  name="resolution" value="320x320"/>
						<label for="320x320">&nbsp;320x320 <?php echo $lang['ATOZ34']; ?></label>
						<div class="clear">&nbsp;</div>
						
                        <input type="radio" id="640x480"  name="resolution" value="640x480"/>
						<label for="640x480">&nbsp;640x480 <?php echo $lang['ATOZ34']; ?></label>
						<div class="clear">&nbsp;</div>
						
                        <input type="radio" id="800x600"  name="resolution" value="800x600"/>
						<label for="800x600">&nbsp;800x600 <?php echo $lang['ATOZ34']; ?></label>
						<div class="clear">&nbsp;</div>
						
                        <input type="radio" id="1024x768"  name="resolution" value="1024x768" checked="checked" />
						<label for="1024x768">&nbsp;1024x768 <?php echo $lang['ATOZ34']; ?></label>
                        <div class="clear">&nbsp;</div>
                        
                        <input type="radio" id="1366x768"  name="resolution" value="1366x768" />
						<label for="1366x768">&nbsp;1366x768 <?php echo $lang['ATOZ34']; ?></label>
                        <div class="clear">&nbsp;</div>
						
                        <input type="radio" id="1152x864"  name="resolution" value="1152x864"/>
						<label for="1152x864">&nbsp;1152x864 <?php echo $lang['ATOZ34']; ?></label>
						<div class="clear">&nbsp;</div>
						
                        <input type="radio" id="1600x1200"  name="resolution" value="1600x1200"/>
						<label for="1600x1200">&nbsp;1600x1200 <?php echo $lang['ATOZ34']; ?></label>
						<div class="clear">&nbsp;</div>	
					</div>
						
					</p>
					<div>
                        <button class="btn btn-sm btn-info"><?php echo $lang['ATOZ35']; ?></button>
					</div>
			</form>    
