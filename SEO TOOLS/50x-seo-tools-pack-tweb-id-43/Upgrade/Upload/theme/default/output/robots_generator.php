...
?>
<script>
var msg1 = "<?php makeJavascriptStr($lang['ATOZ163'],true); ?>";
var msg2 = "# <?php makeJavascriptStr($lang['ATOZ164'],true); ?>\n";
</script>
...
<form>
  <div>
	<table id="roboTable" class="nostyle">
      <tbody><tr>
      <td><b><?php echo $lang['ATOZ150']; ?>:</b></td>
      <td>
		<select size="1" name="allow" id="allow" class="form-control" >
<option value=" " selected=""><?php echo $lang['ATOZ151']; ?></option>
<option value=" /"><?php echo $lang['ATOZ152']; ?></option> </select></td>
       <td>&nbsp;</td>
      </tr>
      ...
      <tr>
      <td><b><?php echo $lang['ATOZ153']; ?>:</b></td>
      <td colspan="2">
		<select size="1" name="delay" id="delay" class="form-control">
			<option value="" selected=""><?php echo $lang['ATOZ154']; ?></option>
      ...
      <tr>
      <td><strong><?php echo $lang['ATOZ155']; ?>: <small><?php echo $lang['ATOZ156']; ?>&nbsp;</small></strong></td>
      <td colspan="2">
      ...
      <td><b><?php echo $lang['ATOZ157']; ?>:</b></td>
      <td>
Google</td>
      <td>
		<select size="1" name="google" id="google" class="form-control">
<option value="" selected=""><?php echo $lang['ATOZ158']; ?></option>
<option value=" "><?php echo $lang['ATOZ151']; ?></option>
<option value=" /"><?php echo $lang['ATOZ152']; ?></option>
</select></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
<option value=" /"><?php echo $lang['ATOZ152']; ?></option>
    ...
    <tr>
      <td><b><?php echo $lang['ATOZ159']; ?>:</b></td>
      <td colspan="2">
		<i><?php echo $lang['ATOZ160']; ?> "/"</i></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2">
    ...
    <p>
	<input type="button" class="btn btn-success" onclick="genRobots(this.form,msg1,msg2)" value="<?php echo $lang['ATOZ161']; ?>" /> 
