...
<div class="row">
        ...
        <table class="table table-bordered table-hover table-striped">
            <tbody>
                    <tr>
                        <td style="width:200px;"><?php echo $lang['ATOZ98']; ?></td>
                        <td><strong><?php echo $my_url; ?></strong></td>
                    </tr>
                    <tr>
                        <td style="width:200px;"><?php echo $lang['ATOZ99']; ?></td>
         ...
         <table class="table table-bordered table-hover table-striped">
            <tbody>
                    <tr>
                        <td style="width:200px;"><?php echo $lang['ATOZ100']; ?></td>
                        <td><strong><?php echo count($cssLinks); ?></strong></td>
                    </tr>
                    <tr>
                        <td style="width:200px;"><?php echo $lang['ATOZ101']; ?></td>
                        <td><strong><?php echo count($scriptLinks); ?></strong></td>
                    </tr>
                    <tr>
                        <td style="width:200px;"><?php echo $lang['ATOZ102']; ?></td>
                        <td><strong><?php echo count($imgLinks); ?></strong></td>
                    </tr>
                    
                    <tr> 
                        <td style="width:200px;"><?php echo $lang['ATOZ103']; ?></td>
