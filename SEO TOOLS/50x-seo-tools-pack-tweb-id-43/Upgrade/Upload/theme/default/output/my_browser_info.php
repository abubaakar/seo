        ...
        <div class="xd_top_box">
         <?php echo $ads_720x90; ?>
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                <tr>
                    <td><strong><?php echo $lang['ATOZ175']; ?></strong></td>
                     <td><span class="badge bg-green"><?php   echo $browser; ?></span></td>
    
                </tr>
                <tr>
                    <td><strong><?php echo $lang['ATOZ176']; ?></strong></td>
                    <td><span class="badge bg-aqua"><?php   echo $version; ?></span></td>
    
                </tr>
                <tr>
                   <td><strong><?php echo $lang['ATOZ177']; ?></strong></td>
                    <td><span class="badge bg-purple"><?php   echo $platform; ?></span></td>
                </tr>
                <tr>
                   <td><strong><?php echo $lang['ATOZ178']; ?></strong></td>
