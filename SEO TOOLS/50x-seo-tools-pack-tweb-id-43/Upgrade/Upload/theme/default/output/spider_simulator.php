...
<div class="row">
        ...
        <div class="xd_top_box">
         <?php echo $ads_720x90; ?>
           ...
           ?>
        <br />      
        <h4><?php echo $lang['ATOZ331']; ?></h4>
        <table class="table table-bordered table-hover table-striped">
            <tbody>
                    <tr>
                        <td style="width:200px;"><?php echo $lang['ATOZ30']; ?></td>
                        <td><strong><?php echo $meta_title; ?></strong></td>
                    </tr>
                    <tr>
                        <td style="width:200px;"><?php echo $lang['ATOZ31']; ?></td>
                        <td><strong><?php echo $meta_description; ?></strong></td>
                    </tr>
                    <tr>
                        <td style="width:200px;"><?php echo $lang['ATOZ32']; ?></td>
		...
		<table class="table table-hover table-bordered table-striped" style="margin-bottom: 30px;">
			<thead>
				<tr>
					<th class="text-center"><?php echo ucwords($tagName).' '.$lang['ATOZ333']; ?></th>
				</tr>
			</thead>
			<tbody>
				<?php
