...
<div class="row">
        ...
        <div class="xd_top_box">
         <?php echo $ads_720x90; ?>
           ...
           <input class="btn btn-info" onclick="processLoadBar();" type="submit" value="<?php echo $lang['ATOZ8']; ?>" name="submit"/>
           </div>
           </form>     
        ...
        <h4><?php echo $lang['ATOZ49']; ?><small> <?php echo $lang['ATOZ52']; ?> </small></h4>
		<table class="table table-hover table-bordered table-striped" style="margin-bottom: 30px;">
			<thead>
				<tr>
					<th><?php echo $lang['ATOZ98']; ?></th>
					<th style="width: 10%;"><?php echo $lang['ATOZ322']; ?></th>
                    <th style="width: 15%;"><?php echo $lang['ATOZ69']; ?></th>
			    </tr>
			</thead>
			<tbody>
				<?php
				...
				<tr>
					...
					<td style="color: <?php echo $internalLink[2]; ?>;"><?php echo ($internalLink[1] == 404) ? $lang['ATOZ323'] : $lang['ATOZ324']; ?></td>
				</tr>
				<?php
					}
				?>
        ...
        <h4><?php echo $lang['ATOZ50']; ?><small> <?php echo $lang['ATOZ55']; ?> </small></h4>
		<table class="table table-hover table-bordered table-striped" style="margin-bottom: 30px;">
			<thead>
				<tr>
					<th><?php echo $lang['ATOZ98']; ?></th>
			...
			<tbody>
				...
				<tr>
					...
					<td style="color: <?php echo $externalLink[2]; ?>;"><?php echo ($externalLink[1] == 404) ? $lang['ATOZ323'] : $lang['ATOZ324']; ?></td>
				</tr>
				<?php
					}
				?>
